...
export const INITIAL_APPLICATIONS: AdoptionApplication[] = [
  {
    ...
    applicantLocation: 'Kolkata, New Town (5 km away)',
    applicantLat: 22.5726,
    applicantLng: 88.4639,
    applicantPhone: '+91 98765 43210',
    applicantEmail: 'sarah.jenkins@gmail.com',
    reason: 'We have a fenced 2000 sq ft green garden and another friendly Golden Retriever. Bruno will have 24/7 care since I work from home!',
    homeType: 'House',
    hasYard: true,
    otherPets: '1 friendly spayed Golden Retriever',
    experienceWithDogs: 'Over 12 years of Golden Retriever parenting experience.',
  ...
  },
  {
    ...
    dogBreed: 'Indie / Desi Dog',
    applicantId: 'user_sarah',
    applicantName: 'Sarah Jenkins',
    applicantAvatar: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=400&auto=format&fit=crop&q=80',
    applicantLocation: 'Kolkata, Salt Lake (3 km away)',
    applicantLat: 22.5867,
    applicantLng: 88.4171,
    applicantPhone: '+91 98765 43210',
    applicantEmail: 'sarah.jenkins@gmail.com',
    reason: 'Luna needs a peaceful home to recover and bond. I love indie dogs and have a quiet home with plenty of love to give.',
    homeType: 'Apartment',
    hasYard: true,
    otherPets: 'None',
    experienceWithDogs: 'Experienced with indie rescue dogs.',
    vetCareAgreement: true,
    workSchedule: 'Flexible Remote Hours',
    preferredMeetDate: 'This weekend at Central Park, 4:00 PM',
    status: 'submitted',
  ...
  },
  {
    ...
    dogId: 'dog_rocky',
    dogName: 'Rocky',
    dogPhoto: 'https://images.unsplash.com/photo-1589941013453-ec89f33b5e95?w=800&auto=format&fit=crop&q=80',
    dogBreed: 'German Shepherd',
    applicantId: 'user_david',
    applicantName: 'Dr. David Chen',
    applicantAvatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&auto=format&fit=crop&q=80',
    applicantLocation: 'Mumbai, Bandra (12 km away)',
    applicantLat: 19.0596,
    applicantLng: 72.8295,
    applicantPhone: '+91 91234 56789',
    applicantEmail: 'david.chen@pethealth.org',
    reason: 'As a practicing veterinarian, Rocky will receive the best medical care, daily active running, and professional training.',
    homeType: 'House',
    hasYard: true,
    otherPets: 'None',
    experienceWithDogs: '15+ years veterinary canine specialist.',
    vetCareAgreement: true,
    workSchedule: 'Clinic hours with afternoon off',
    preferredMeetDate: 'August 10, 2026',
    status: 'completed',
    submittedAt: 'August 08, 2026',
    reviewedAt: 'August 08, 2026'
  }
];
