      ...
      try {
        ...
        if (isMounted && Array.isArray(cloudDogs) && cloudDogs.length > 0) {
          const formatted: Dog[] = cloudDogs.map((d: any) => ({
            ...
            size: d.size || 'Medium',
            energy: d.energy || 'Moderate',
            location: d.location || 'Kolkata, West Bengal',
            lat: d.lat || 22.5726,
            lng: d.lng || 88.3639,
            city: d.city || 'Kolkata',
            state: d.state || 'West Bengal',
            pincode: d.pincode || '700001',
            coverPhoto: d.coverPhoto || 'https://images.unsplash.com/photo-1543466835-00a7907e9de1?w=800',
            photos: d.photos || [d.coverPhoto || 'https://images.unsplash.com/photo-1543466835-00a7907e9de1?w=800'],
            bio: d.bio || d.description || d.story || 'Loving adoptable pup looking for a forever family.',
            reasonForAdoption: d.reasonForAdoption || 'Looking for a caring guardian',
            adoptionType: d.adoptionType || 'Free Adoption',
            adoptionFee: d.adoptionFee,
            status: d.status || 'available',
            currentOwnerId: d.currentOwnerId || 'user_dipu',
            currentOwnerName: d.currentOwnerName || 'Guardian',
            currentOwnerAvatar: d.currentOwnerAvatar || 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=400',
            currentOwnerPhone: d.currentOwnerPhone,
            isOwnerVerified: d.isOwnerVerified ?? true,
            ...
            vaccinated: d.vaccinated ?? d.isVaccinated ?? true,
            neutered: d.neutered ?? d.isNeutered ?? true,
            microchipped: d.microchipped ?? true,
            medicalNotes: d.medicalNotes || d.medicalNeeds || 'All vaccinations up to date.',
            favoriteThings: d.favoriteThings || ['Belly rubs', 'Playing fetch', 'Park runs'],
            personalityTraits: d.personalityTraits || d.temperament || ['Friendly', 'Playful', 'Affectionate'],
